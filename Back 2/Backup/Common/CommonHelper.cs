...
namespace RiccoTest2.Common
{
    public partial class CommonHelper
    {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new Exception("No property '{0}' found on the instance of type '{1}'.", null);
            if (!pi.CanWrite)
                throw new Exception("The property '{0}' on the instance of type '{1}' does not have a setter.", null);
